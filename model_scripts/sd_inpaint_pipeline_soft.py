...
class StableDiffusionInpaintPipelineSoft(StableDiffusionInpaintPipeline):
    def __init__(
            self,
    ...
    def __call__(
        ...
        # mask_condition = torch.where(mask_condition > 0.5, 1, mask_condition)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if num_channels_unet == 4:
                    ...
                    # latents = latent_blend(settings, init_latents_proper, latents, init_mask)
